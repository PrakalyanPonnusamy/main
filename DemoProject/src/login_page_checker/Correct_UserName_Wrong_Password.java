...
public class Correct_UserName_Wrong_Password {

	@Test
	@Parameters({"username","password"}) // Using at parameter to get username and password
	public void Pass_Wrong(String name, String pass) { // here we are passing the paramenters inside the method for the execution
