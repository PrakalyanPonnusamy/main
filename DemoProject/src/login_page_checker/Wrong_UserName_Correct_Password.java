...
public class Wrong_UserName_Correct_Password {
	@Test
	@Parameters({"username","password"}) // Using at parameter to get username and password
	public void UN_wrong(String name, String pass) { // here we are passing the paramenters inside the method for the execution
